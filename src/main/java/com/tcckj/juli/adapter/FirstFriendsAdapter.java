...
public class FirstFriendsAdapter extends RecyclerView.Adapter<FirstFriendsAdapter.MyHolder> {
    private Context context;
    private List<Map<String, Object>> list;

    public FirstFriendsAdapter(Context context, List<Map<String, Object>> list) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_first_friend, parent, false);
